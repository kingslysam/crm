      ...
      <SheetContent side="left" className="max-w-[736px]">
        ...
        <div className="py-6">
          ...
          <ul className="md:grid grid-cols-2 gap-2 space-y-2 md:space-y-0">
            ...
            <li><span className="text-sm text-default-600 ">Account:</span><span className="text-default-500 ">prantik@simplify.tech</span></li>
          ...
          <ul className="md:grid grid-cols-2 gap-2 space-y-2 md:space-y-0">
            ...
            <li><span className="text-sm text-default-600 ">Supervisor:</span> <span className="text-warning"> Simplify</span></li>
          ...
          <ul className="md:grid grid-cols-2 gap-2 space-y-2 md:space-y-0">
            <li><span className="text-sm text-default-600 ">Email:</span> <span className="text-default-500 ">prantik@simplify.tech</span></li>

...
import simplify from "@/public/images/all-img/simplify-screenshot.png"
        ...
        <Container className="mx-auto bg-white rounded">
          <Row>
            ...
            <Column className="flex justify-end pt-10 pr-5   ">
              <Button
                href="https://simplify.co.tz/contact-us"
          ...
          <Section className="mt-5">
            <Row>
              <Column className="pl-5 w-1/2">
                ...
                <Text className="text-xl  font-semibold text-slate-900 -mt-3">Simplify</Text>

              ...
              <Row>
                <Column className="flex flex-col items-center relative before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gray-900/60 before:z-10 py-10 pb-16">
                  ...
                  <Text className="relative z-30 text-center text-base text-white  px-10 my-0">
                    Simplify is a creative agency that helps people to bring their business online.
                ...
                <Column className="bg-gray-50 py-10 px-5">
                  <Row>
                    ...
                    <Column className="w-1/2">
                      ...
                      <Text className="text-sm texty-gray-500">Simplify is a creative agency that helps people to bring their business online.
            ...
            <Section>
              <Row>
                <Column className="bg-gray-50 text-gray-900 py-10 px-10 mt-4 flex flex-col items-center">
                  ...
                  <Text className="text-base text-center mt-0">Simplify is a creative agency that helps people to bring their business online.
                    we also offer various digital marketing, web design, and development services.</Text>
                ...
                <Column className="bg-gray-900 text-white pt-12 px-10">
                  <Row>
                    <Column className="pr-2 w-1/3">
                      ...
                      <Text className="text-sm text-slate-400">Simplify is a creative agency that helps people to bring their business online.</Text>
                    </Column>
                  ...
                  <Row>
                    <Column className="pt-10 pb-2">
                      <Text className="text-xs text-slate-300">COPYRIGHT &copy; 2024 Simplify All rights <br /> Reserved</Text>
                    </Column>
                    <Column className="pt-10 pb-2">
